...
Black__sp__to__sp__Orange = hou.Ramp(
    (linear, linear),
    (0, 1),
    ((0, 0, 0), (1, 0.325, 0.1))
    )
...
Twilight__sp__Shifted = hou.Ramp(
...
White__sp__to__sp__Red = hou.Ramp(
    (linear, linear),
    (0, 1),
    ((1, 1, 1), (1, 0, 0))
    )
